...
const DashboardWidget = ({ title, children, icon }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md min-h-full w-full relative transition-all duration-300 hover:shadow-lg">
      ...
      <h3 className="text-lg font-semibold mb-3 pl-6 flex items-center relative">
        {renderIcon()}
        {title}
      </h3>
